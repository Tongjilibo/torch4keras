...
from torch4keras.callbacks import Checkpoint, Evaluator, EarlyStopping, Summary, Logger, EmailCallback, WandbCallback, Tensorboard, SmoothMetricCallback
...
if __name__ == '__main__':
    ...
    smooth = SmoothMetricCallback(interval=100)  # 指标平滑
